...
var y, x, p, q, r, s : integer;
    Hints, ThisCombo, ThisCell, ShouldNotHave : string;
    ...
    begin
        ...
        for ThisCombo in GetThreeCombination(Hints) do
            ...
            begin
                ...
                for p := 1 to 3 do
                    ShouldNotHave := SBA_RemoveAt(ShouldNotHave, pos(ThisCombo[p], ShouldNotHave));
                            ...
                            begin
                                ...
                                begin
                                    ...
                                    begin
                                        ...
                                        NakedTripleCount := NakedTripleCount + 1;
                                        LockedLeftX := 3*(s div 3);
                                        LockedLeftY := 3*(r div 3);
                                    end;
                                end;
...
//     IsLockedTriple, HasNakedTriple, OnceIsLockedTriple : boolean;
// begin
//     for y := 0 to 8 do
//         for x := 0 to 8 do
//             if length(hint[y, x]) = 3 then
//             begin
//                 OnceIsLockedTriple := false;
...
//                     OnceIsLockedTriple := true;
//                     WriteStepHint(y, x, 'Naked  Triple', '-['+hint[y, x]+'] due to row '+SBA_IntToStr(y));
//                 end;
...
//                     WriteStepHint(y, x, 'Locked Triple', '-['+hint[y, x]+'] for sub '+SBA_IntToStr((3*(s div 3)+(r div 3)))+' (row)');
//                 end;
...
//                     WriteStepHint(y, x, 'Naked  Triple', '-['+hint[y, x]+'] due to col '+SBA_IntToStr(x));
//                 end;
...
//                     OnceIsLockedTriple := true;
//                     WriteStepHint(y, x, 'Locked Triple', '-['+hint[y, x]+'] for sub '+SBA_IntToStr((3*(s div 3)+(r div 3)))+' (column)');
//                 end;

                

//                 // Subgrid
//                 if not OnceIsLockedTriple then
//                 begin
//                     NakedTripleCount := 0;
//                     ShouldNotHave := '123456789';
//                     for p := 1 to 3 do
...
//                                 SubgridCellID := SubgridCellID + 1;
//                             end;
//                             WriteStepHint(y, x, 'Naked  Triple', '-['+hint[y, x]+'] due to sub '+SBA_IntToStr((3*(s div 3)+(r div 3))));
//                     end;
//                 end;
//             end;
// end;
